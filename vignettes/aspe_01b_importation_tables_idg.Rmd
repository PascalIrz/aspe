...
Pour des raisons de sécurité (*et de bonnes pratiques*), il convient de ne pas exposer les informations sensibles de connexion à tous. C'est pourquoi, il est nécessaire de stocker ces informations dans  l'environnement `R` (fichier `.Renviron`). La fonction de connexion à la base aspe via l'IDG utilise ces informations (càd. nommées ainsi).
