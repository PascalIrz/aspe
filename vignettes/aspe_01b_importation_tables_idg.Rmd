...
Pour éviter d'avoir à répéter cet import, on peut en sauvegarder le résultat au format `.RData` de façon à y accéder plus rapidement par la suite. La fonction `export_tables_rdata()` peut être utilisée pour cela. 
