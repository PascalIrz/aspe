...
Les premières lignes de cette table :
...
Ces identifiants se réfèrent aux lignes des tables suivantes :
...
Quelques lignes tirées au hasard :
...
Ajout du code EPSG aux points (table `point_prelevement`).
...
Coordonnées des points en Lambert 93.
...
- on juxtapose au `dataframe pops` les colonnes de coordonnées qui sont dans le `dataframe` nommé `coords`
