...
#'
#'
importer_dump_sql <- function(fichier_dump) {
  ...
  lignes_dump <- lire_lignes_dump_sql (fichier_dump)

  options(stringsAsFactors = F)

  noms_tables <- extraire_noms_tables (lignes_dump = lignes_dump)

  importer_tables_a_partir_des_lignes (lignes_dump = lignes_dump,
