...
#' @export
#'
#' @importFrom ggplot2 ggplot aes coord_cartesian geom_line geom_point facet_grid labs guides theme element_text
...

{
  ...
  # passage de la variable d'identification de la station en facteur et découpage si dépasse 25 caractères
  df_metriques <- df_metriques %>%
    mutate(
      !!var_id_sta := str_wrap(!!var_id_sta, 25),
