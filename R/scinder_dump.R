...
#' @examples
#' \dontrun{
#' scinder_dump(fichier_dump = "../raw_data/dump.sql")
#' }
#'
scinder_dump <- function(fichier_dump, repertoire_sortie = NA) {

lignes <- lire_lignes_dump_sql(fichier_dump)

# Extraction des noms des tables
noms_tables <- extraire_noms_tables(lignes_dump = lignes)
